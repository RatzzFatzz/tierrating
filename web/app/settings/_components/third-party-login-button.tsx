...
export default function ThirdPartyLoginButton({ title, path, service }: { title: string; path: string; service: string }) {
	return (
		<Link key={service} href={path} className="block w-full">
