...
export function assignTiersAndGroupEntriesByTier(
  tiers: Tier[],
  items: TierlistEntry[]
): Map<string, TierlistEntry[]> {
  ...
  Array.from(entriesByTier.keys()).forEach((key) =>
    entriesByTier.set(key, entriesByTier.get(key)!.sort(sortByName))
  );
